...
const createStyles = (colors: any) => StyleSheet.create({
  streamCard: {
    flexDirection: 'row',
    alignItems: 'center',
    padding: isMacCatalyst ? 20 : 14,
    borderRadius: 14,
    marginBottom: isMacCatalyst ? 12 : 8,
    minHeight: isMacCatalyst ? 84 : 60,
  ...
  scraperLogoContainer: {
    width: isMacCatalyst ? 36 : 32,
    height: isMacCatalyst ? 36 : 32,
    marginRight: 14,
  ...
  scraperLogo: {
    width: isMacCatalyst ? 26 : 22,
    height: isMacCatalyst ? 26 : 22,
  },
  streamCardLoading: {
    opacity: 0.6,
  },
  ...
  streamName: {
    fontSize: isMacCatalyst ? 18 : 13,
    fontWeight: '600',
    lineHeight: isMacCatalyst ? 24 : 18,
  ...
  pillsRow: {
    flexDirection: 'row',
    flexWrap: 'wrap',
    gap: isMacCatalyst ? 8 : 5,
    alignItems: 'center',
  },
  pill: {
    paddingHorizontal: isMacCatalyst ? 12 : 8,
    paddingVertical: isMacCatalyst ? 5.5 : 3,
    borderRadius: 8,
    borderWidth: 1,
  },
  pillText: {
    fontSize: isMacCatalyst ? 12.5 : 10,
    fontWeight: '700',
    letterSpacing: 0.3,
